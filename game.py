...
class Piece():
	def __init__(self, board, card_type, attack, defense, movement, x, y):
		self.board = board
...
class GameBoard(tk.Frame):
    def __init__(self, parent, rows=5, columns=4, size=64, color1="white", color2="white"):
...
if __name__ == "__main__":
    ...
    board1 = GameBoard(root)
    board1.pack(side="top", fill="both", expand="true", padx=4, pady=4)
